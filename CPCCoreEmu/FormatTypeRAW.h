...
private:
   ...
   unsigned short GetW(FILE* file);
   unsigned short GetWFromBuffer(const unsigned char* buffer, int& pos);
   unsigned long GetDW(FILE* file);
   unsigned long GetDWFromBuffer(const unsigned char* buffer, int& pos);
